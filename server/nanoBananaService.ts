...
export async function generateFestiveTransform(params: {
  ...
  const sceneDescriptions: Record<string, string> = {
    ...
    // Business Festive Transform Scenes - workplace-appropriate celebrations
    'professional-celebration': 'an elegant professional celebration setting with tasteful confetti, champagne glasses, subtle decorations, modern office party atmosphere, sophisticated corporate celebration',
    'milestone-moment': 'a professional achievement celebration with spotlight effect, subtle golden accents, career milestone recognition, polished office setting, success and accomplishment atmosphere',
    'team-celebration': 'a professional team success celebration with modern office setting, collaborative atmosphere, team achievement vibes, corporate group celebration, unity and success',
    'client-appreciation': 'an elegant client appreciation setting with premium thank-you atmosphere, professional gratitude expression, sophisticated business relationship celebration, refined corporate aesthetic',
    'event-gathering': 'a professional corporate event setting with elegant decorations, networking atmosphere, company gathering vibes, polished business social event, formal yet celebratory',
    'seasonal-festive': 'a tasteful seasonal celebration setting with neutral winter or year-end decorations, workplace-appropriate festive atmosphere, professional holiday spirit without religious symbols, inclusive celebration',
    'brand-celebration': 'a modern brand celebration setting with corporate identity elements, company colors as accents, professional branding celebration, polished marketing event atmosphere',
    'modern-abstract-festive': 'a contemporary abstract celebration setting with soft gradient colors, geometric shapes, modern minimal festive elements, professional and artistic celebration atmosphere',
    // Education Festive Transform Scenes - school-safe celebrations
    'student-celebration': 'a bright encouraging student celebration scene with colorful balloons, confetti, star decorations, achievement ribbons, positive energy, school-appropriate festive atmosphere, encouraging educational celebration',
    'academic-achievement': 'an academic achievement celebration with honor roll banner, gold star decorations, certificate scrolls, proud achievement atmosphere, school recognition ceremony, academic excellence celebration',
    'edu-graduation': 'a proud graduation celebration with cap and gown elements, diploma scroll, graduation cap throwing in background, celebratory streamers, next chapter excitement, milestone achievement atmosphere',
    'teacher-appreciation': 'a warm teacher appreciation scene with apple decorations, thank you messages, classroom heart elements, appreciation flowers, educator recognition, grateful student celebration atmosphere',
    'classroom-celebration': 'a joyful classroom celebration with learning decorations, class achievement banner, team success elements, student desks with celebratory items, collaborative learning win atmosphere',
    'school-spirit': 'a spirited school pride scene with mascot energy, school colors prominently featured, pep rally atmosphere, unity decorations, team spirit banners, school community celebration',
    'learning-journey': 'a inspiring learning journey scene with progress path elements, milestone markers, stepping stones of achievement, growth visualization, educational progress celebration, encouraging atmosphere',
  ...
  const styleInstructions: Record<string, string> = {
    ...
    // Business Festive Transform Styles - Professional Celebration
    'elegant-confetti': 'elegant celebration with tasteful confetti falling, professional party atmosphere',
    'subtle-sparkle': 'subtle sparkle effects, refined glitter accents, sophisticated celebration',
    'achievement-glow': 'warm achievement glow lighting, success spotlight effect',
    'polished-cheers': 'polished champagne toast atmosphere, elegant celebration',
    'soft-gold-accents': 'soft gold accent lighting, premium celebration feel',
    'modern-celebration': 'modern minimalist celebration style, clean and contemporary',
    'corporate-festive': 'professional corporate party atmosphere, office celebration',
    'minimal-party': 'minimal party elements, understated celebration aesthetic',
    // Business Festive - Milestone Moment
    'promotion-spotlight': 'career promotion spotlight, achievement recognition, professional success',
    'work-anniversary': 'work anniversary celebration, years of service recognition',
    'career-growth': 'career growth and advancement, professional development celebration',
    'achievement-marker': 'achievement milestone marker, professional accomplishment',
    'timeline-highlight': 'career timeline highlight, milestone moment recognition',
    'next-level': 'next level achievement, professional advancement celebration',
    'success-step': 'success step forward, career progress celebration',
    'recognition-frame': 'recognition frame and spotlight, professional acknowledgment',
    // Business Festive - Team Celebration
    'team-win': 'team victory celebration, group success atmosphere',
    'collective-success': 'collective success celebration, team achievement',
    'collaboration-energy': 'collaboration energy, team synergy celebration',
    'unity-highlights': 'team unity highlights, together achievement',
    'together-we-did-it': 'together we did it moment, shared victory',
    'momentum-flow': 'momentum and flow celebration, team progress',
    'shared-achievement': 'shared achievement recognition, group accomplishment',
    'connected-wins': 'connected wins celebration, team bond success',
    // Business Festive - Client Appreciation
    'thank-you-elegant': 'elegant thank you atmosphere, refined gratitude',
    'premium-gratitude': 'premium gratitude expression, high-end appreciation',
    'partnership-celebration': 'partnership celebration, business relationship recognition',
    'valued-relationship': 'valued relationship atmosphere, client importance',
    'trusted-partner': 'trusted partner recognition, reliability celebration',
    'appreciation-note': 'appreciation note atmosphere, sincere thank you',
    'professional-warmth': 'professional warmth, business relationship care',
    'relationship-focus': 'relationship focus, client-centered celebration',
    // Business Festive - Event & Gathering
    'company-event': 'company event atmosphere, corporate gathering',
    'conference-energy': 'conference energy, professional networking event',
    'corporate-social': 'corporate social event, business casual gathering',
    'annual-celebration': 'annual celebration, yearly company event',
    'networking-night': 'networking night atmosphere, professional social',
    'brand-gathering': 'brand gathering, company identity event',
    'formal-festive': 'formal festive event, elegant business celebration',
    'event-highlights': 'event highlights, special gathering moments',
    // Business Festive - Seasonal (Business-Safe)
    'winter-neutral': 'neutral winter atmosphere, inclusive seasonal celebration',
    'year-end-celebration': 'year-end celebration, end of year recognition',
    'seasonal-glow': 'seasonal glow lighting, warm winter atmosphere',
    'festive-minimal': 'minimal festive elements, understated seasonal',
    'new-year-forward': 'new year forward looking, fresh start celebration',
    'holiday-abstract': 'abstract holiday patterns, non-denominational festive',
    'seasonal-professional': 'professional seasonal celebration, workplace appropriate',
    'end-of-year-warmth': 'end of year warmth, closing celebration',
    // Business Festive - Brand Celebration
    'logo-spotlight': 'brand logo spotlight, company identity celebration',
    'brand-colors-festive': 'brand colors in festive context, company palette celebration',
    'identity-glow': 'brand identity glow, company presence celebration',
    'corporate-signature': 'corporate signature style, brand aesthetic celebration',
    'branded-confetti': 'branded confetti, company colors celebration',
    'typography-celebration': 'typography celebration, brand font showcase',
    'minimal-brand-party': 'minimal brand party, subtle company celebration',
    'polished-identity': 'polished brand identity, refined company aesthetic',
    // Business Festive - Modern Abstract
    'gradient-motion': 'gradient motion effects, flowing color celebration',
    'soft-light-trails': 'soft light trails, gentle motion celebration',
    'abstract-spark': 'abstract spark elements, artistic celebration',
    'minimal-celebration': 'minimal celebration, understated festive',
    'geometric-festive': 'geometric festive patterns, modern shapes celebration',
    'motion-shapes': 'motion shapes, dynamic abstract celebration',
    'clean-energy': 'clean energy aesthetic, fresh modern celebration',
    'contemporary-glow': 'contemporary glow, modern artistic celebration',
    // Education Festive - Student Celebration Styles
    'you-did-it': 'celebratory "You Did It!" achievement atmosphere, encouraging positive energy, student success celebration',
    'edu-proud-moment': 'proud achievement moment, recognition and encouragement, student accomplishment spotlight',
    'star-student': 'star student recognition, gold star decorations, excellence celebration',
    'celebration-confetti': 'colorful confetti celebration, festive achievement party, joyful success',
    'edu-achievement-glow': 'glowing achievement atmosphere, warm accomplishment lighting, proud moment',
    'big-smile-energy': 'bright and happy energy, encouraging smile atmosphere, positive celebration',
    'success-spark': 'sparkling success celebration, achievement twinkle, encouraging atmosphere',
    'way-to-go': 'encouraging "Way to Go!" celebration, supportive achievement recognition',
    // Education Festive - Academic Achievement Styles
    'honor-roll': 'honor roll recognition, academic excellence banner, scholarly achievement',
    'perfect-attendance': 'perfect attendance celebration, consistency recognition, dedication award',
    'academic-excellence': 'academic excellence celebration, scholarly achievement, educational success',
    'achievement-badge': 'achievement badge recognition, merit award, student accomplishment',
    'gold-star': 'gold star recognition, top achievement award, excellence celebration',
    'top-performer': 'top performer spotlight, outstanding achievement, academic star',
    'certificate-style': 'formal certificate recognition, official achievement, academic award',
    'scholar-spotlight': 'scholar spotlight celebration, academic recognition, intellectual achievement',
    // Education Festive - Graduation Styles
    'class-of-year': 'class of year celebration, graduating class recognition, milestone year',
    'cap-and-gown': 'cap and gown graduation, formal academic celebration, commencement ceremony',
    'graduation-glow': 'graduation celebration glow, milestone achievement lighting, proud moment',
    'edu-next-chapter': 'next chapter celebration, new beginning, future-forward graduation',
    'proud-graduate': 'proud graduate celebration, achievement recognition, graduation success',
    'edu-milestone-moment': 'milestone moment celebration, significant achievement, graduation landmark',
    'future-forward': 'future forward celebration, exciting new beginnings, optimistic graduation',
    'diploma-day': 'diploma day celebration, graduation achievement, academic completion',
    // Education Festive - Teacher Appreciation Styles
    'thank-you-teacher': 'heartfelt thank you teacher appreciation, gratitude celebration, educator recognition',
    'classroom-hero': 'classroom hero recognition, teacher appreciation, educational champion',
    'making-a-difference': 'making a difference recognition, educator impact, teacher appreciation',
    'educator-spotlight': 'educator spotlight celebration, teacher recognition, appreciation moment',
    'heart-of-classroom': 'heart of the classroom recognition, teacher dedication, appreciation warmth',
    'edu-appreciation-note': 'appreciation note atmosphere, sincere thank you, teacher gratitude message',
    'inspiring-educator': 'inspiring educator celebration, motivational teacher, appreciation recognition',
    'gratitude-frame': 'gratitude frame appreciation, thankful recognition, teacher appreciation border',
    // Education Festive - Classroom Celebration Styles
    'class-success': 'class success celebration, group achievement, collective accomplishment',
    'we-did-it': 'we did it celebration, team achievement, group success recognition',
    'team-classroom': 'team classroom celebration, collaborative success, group achievement',
    'learning-together': 'learning together celebration, collaborative education, group progress',
    'class-pride': 'class pride celebration, group identity, classroom achievement',
    'group-achievement': 'group achievement recognition, team success, classroom milestone',
    'classroom-cheers': 'classroom cheers celebration, group enthusiasm, collective joy',
    'learning-wins': 'learning wins celebration, educational success, classroom achievement',
    // Education Festive - School Spirit Styles
    'school-pride': 'school pride celebration, institutional spirit, community pride',
    'mascot-energy': 'mascot energy celebration, school spirit, team enthusiasm',
    'school-colors': 'school colors celebration, institutional identity, spirit display',
    'spirit-day': 'spirit day celebration, school enthusiasm, community energy',
    'go-team': 'go team celebration, school spirit, enthusiastic support',
    'unity-and-pride': 'unity and pride celebration, school community, collective spirit',
    'school-community': 'school community celebration, institutional togetherness, collective spirit',
    'pride-banner': 'pride banner celebration, school spirit display, institutional recognition',
    // Education Festive - Learning Journey Styles
    'growth-path': 'growth path visualization, learning progress, educational journey',
    'learning-milestones': 'learning milestones celebration, educational progress, achievement markers',
    'progress-map': 'progress map visualization, learning journey, educational path',
    'step-by-step': 'step by step progress, incremental learning, gradual achievement',
    'start-to-success': 'start to success journey, learning transformation, educational progress',
    'learning-in-motion': 'learning in motion celebration, educational progress, dynamic growth',
    'skill-builder': 'skill builder recognition, learning development, educational growth',
    'progress-glow': 'progress glow celebration, learning achievement, educational success lighting',
    // Education Festive - Festive School Celebration Styles
    'end-of-year': 'end of year celebration, school year completion, educational milestone',
    'back-to-school': 'back to school celebration, new school year, fresh start energy',
    'classroom-party': 'classroom party celebration, educational fun, student gathering',
    'school-festive': 'school festive celebration, educational event, age-appropriate party',
    'celebration-day': 'celebration day recognition, special school event, educational festivity',
    'seasonal-cheer': 'seasonal cheer celebration, school seasons, educational festivity',
    'learning-party': 'learning party celebration, educational fun, student celebration',
    'fun-and-focused': 'fun and focused celebration, balanced learning joy, educational party',
    // Education Festive - Fun & Encouraging Styles
    'bright-and-happy': 'bright and happy celebration, colorful joy, encouraging atmosphere',
    'color-pop': 'color pop celebration, vibrant cheerful colors, exciting visual energy',
    'smiles-all-around': 'smiles all around celebration, happy faces, joyful atmosphere',
    'confetti-fun': 'confetti fun celebration, colorful celebration, playful party',
    'friendly-characters': 'friendly characters celebration, approachable fun, child-friendly',
    'joyful-learning': 'joyful learning celebration, happy education, positive atmosphere',
    'positive-vibes': 'positive vibes celebration, encouraging atmosphere, uplifting energy',
    'cheer-boost': 'cheer boost celebration, encouragement energy, motivational atmosphere',
    // Education Festive - Minimal Academic Styles
    'clean-classroom': 'clean classroom aesthetic, minimal academic, refined educational',
    'soft-chalkboard': 'soft chalkboard aesthetic, gentle academic, calm educational',
    'minimal-achievement': 'minimal achievement recognition, understated success, refined celebration',
    'calm-celebration': 'calm celebration atmosphere, peaceful recognition, gentle achievement',
    'simple-success': 'simple success celebration, understated achievement, clean recognition',
    'academic-neutral': 'academic neutral celebration, professional educational, mature recognition',
    'focused-pride': 'focused pride celebration, concentrated achievement, refined recognition',
    'quiet-win': 'quiet win celebration, subtle achievement, understated success',
    // Education Class Portrait Styles (9 scenes x 8 styles = 72 styles)
    // Classroom Portrait Styles
    'traditional-classroom': 'traditional classroom aesthetic, classic school photo, warm academic lighting',
    'chalkboard-background': 'chalkboard background aesthetic, classic educational, learning atmosphere',
    'learning-wall': 'learning wall backdrop, educational posters, academic atmosphere',
    'desk-and-board': 'desk and board setting, classic classroom, academic focus',
    'soft-classroom-light': 'soft classroom lighting, gentle academic glow, warm school atmosphere',
    'neutral-classroom': 'neutral classroom aesthetic, clean educational backdrop, professional',
    'minimal-classroom': 'minimal classroom design, simple educational, clean academic',
    'academic-focus': 'academic focus aesthetic, concentrated learning, scholarly atmosphere',
    // Formal Group Portrait Styles
    'studio-neutral': 'studio neutral backdrop, professional group portrait, clean composition',
    'clean-backdrop': 'clean backdrop aesthetic, simple studio, timeless portrait',
    'classic-school-photo': 'classic school photo aesthetic, traditional portrait, yearbook style',
    'soft-gray-studio': 'soft gray studio backdrop, elegant neutral, professional portrait',
    'white-background': 'white background studio, clean bright, gallery-ready portrait',
    'balanced-group-layout': 'balanced group layout, even spacing, professional composition',
    'centered-composition': 'centered composition, symmetrical arrangement, formal portrait',
    'timeless-portrait': 'timeless portrait aesthetic, classic enduring, professional quality',
    // Campus Outdoors Styles
    'school-courtyard': 'school courtyard setting, outdoor academic, natural campus',
    'front-of-school': 'front of school entrance, building facade, school pride',
    'playground-younger': 'playground setting for younger grades, playful outdoor, fun academic',
    'green-space': 'green space campus, natural outdoor, peaceful school setting',
    'building-entrance': 'building entrance backdrop, architectural, formal outdoor',
    'outdoor-academic': 'outdoor academic setting, natural learning, open campus',
    'natural-light': 'natural light portrait, outdoor glow, fresh academic',
    'casual-school-day': 'casual school day aesthetic, relaxed outdoor, friendly campus',
    // Grade-Level Theme Styles
    'elementary-bright': 'elementary bright aesthetic, colorful cheerful, young learner friendly',
    'middle-school-modern': 'middle school modern aesthetic, contemporary, age-appropriate',
    'high-school-classic': 'high school classic aesthetic, mature academic, traditional',
    'senior-class-style': 'senior class style, graduation ready, milestone aesthetic',
    'early-learners': 'early learners aesthetic, pre-k friendly, playful educational',
    'upper-grades': 'upper grades aesthetic, mature academic, sophisticated',
    'age-appropriate-tone': 'age-appropriate tone, grade-level matching, suitable aesthetic',
    'level-pride': 'level pride aesthetic, grade achievement, class identity',
    // Teacher and Class Styles
    'teacher-center': 'teacher center composition, educator focus, classroom leader',
    'side-by-side': 'side by side arrangement, teacher and students together, equal presence',
    'classroom-leader': 'classroom leader aesthetic, mentor prominence, educational guidance',
    'mentor-moment': 'mentor moment aesthetic, teacher-student connection, learning bond',
    'guided-learning': 'guided learning aesthetic, educational guidance, supportive atmosphere',
    'proud-classroom': 'proud classroom aesthetic, achievement together, collective pride',
    'community-focus': 'community focus aesthetic, classroom unity, together in learning',
    'together-in-learning': 'together in learning aesthetic, collaborative, shared journey',
    // Achievement Class Portrait Styles
    'honor-class': 'honor class aesthetic, excellence recognition, distinguished group',
    'achievement-banner': 'achievement banner backdrop, celebration display, recognition frame',
    'award-winning-class': 'award-winning class aesthetic, champion recognition, excellence',
    'edu-recognition-frame': 'recognition frame aesthetic, formal achievement, award display',
    'class-milestone': 'class milestone aesthetic, achievement marker, celebration moment',
    'excellence-focus': 'excellence focus aesthetic, achievement highlight, quality recognition',
    'class-proud-moment': 'proud moment aesthetic, achievement celebration, recognition glow',
    'celebration-neutral': 'celebration neutral aesthetic, understated achievement, refined recognition',
    // School Identity Styles
    'edu-school-colors': 'school colors aesthetic, branded pride, institutional identity',
    'mascot-subtle': 'mascot subtle aesthetic, school spirit, gentle branding',
    'crest-background': 'crest background aesthetic, school emblem, formal identity',
    'identity-frame': 'identity frame aesthetic, school branding, institutional pride',
    'edu-school-pride': 'school pride aesthetic, spirit display, community identity',
    'district-neutral': 'district neutral aesthetic, professional branding, formal identity',
    'formal-branding': 'formal branding aesthetic, institutional, official portrait',
    'academic-tradition': 'academic tradition aesthetic, legacy, established institution',
    // Fun & Friendly Elementary Styles
    'smiling-classroom': 'smiling classroom aesthetic, happy faces, joyful learning',
    'colorful-backdrop': 'colorful backdrop aesthetic, bright cheerful, fun educational',
    'friendly-shapes': 'friendly shapes aesthetic, playful geometric, child-friendly',
    'happy-learning': 'happy learning aesthetic, joyful education, positive atmosphere',
    'warm-welcoming': 'warm welcoming aesthetic, inviting, friendly classroom',
    'playful-neutral': 'playful neutral aesthetic, fun but clean, child-appropriate',
    'classroom-joy': 'classroom joy aesthetic, celebration of learning, happy students',
    'early-learner-friendly': 'early learner friendly aesthetic, pre-k appropriate, gentle colors',
    // Minimal Portrait Styles
    'clean-white': 'clean white background, pure minimal, gallery-ready',
    'soft-gray': 'soft gray backdrop, elegant neutral, professional minimal',
    'natural-tones': 'natural tones aesthetic, earthy minimal, calm portrait',
    'simple-focus': 'simple focus aesthetic, distraction-free, clean composition',
    'calm-composition': 'calm composition aesthetic, peaceful arrangement, balanced',
    'distraction-free': 'distraction-free aesthetic, minimal elements, focused portrait',
    'professional-neutral': 'professional neutral aesthetic, formal minimal, clean',
    'gallery-ready': 'gallery-ready aesthetic, exhibition quality, refined portrait',
  };
